#
#  Be sure to run `pod spec lint GlShowBigPhoto.podspec' to ensure this is a
...
it is good look big photo
  ...
  s.source       = { :git => "https://github.com/gleeeli/GlShowBigPhoto.git", :tag => "1.0.2" }
